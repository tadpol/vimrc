...
" Last updated by gossamer on Mon Dec 29 00:17:26 EST 1997
...
if !exists("did_mush_syntax_inits")
  let did_mush_syntax_inits = 1
  " The default methods for highlighting.  Can be overridden later
  highlight link mushAttribute Constant
  highlight link mushCommand  Function
  highlight link mushComment  Comment
  highlight link mushNumber	Number
  highlight link mushSetting	PreProc
  highlight link mushFunction Statement
  highlight link mushVariable Identifier
  highlight link mushSpecial	Special
  highlight link mushTodo	   Todo
  highlight link mushFlag     Special
  highlight link mushIdentifier Identifier
endif
" mush: ts=17
